...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("ZigSdlGameTemplate", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "ZigSdlGameTemplate" is the name you will use in your source code to
                // import this module (e.g. `@import("ZigSdlGameTemplate")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "ZigSdlGameTemplate", .module = mod },
            },
        }),
    });

    //const lib = b.addLaddStaticLibrary(.{
    //    .name = "ZigSdlGameTemplate",
